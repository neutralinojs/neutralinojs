...
map<string, router::NativeMethod> methodMap = {
    ...
    {"computer.getDiskInfo", computer::controllers::getDiskInfo},
    ...
    {"os.getLocale", os::controllers::getLocaleInfo},
    ...
    {"net.get", net::controllers::get},
    {"net.post", net::controllers::post},
    {"net.put", net::controllers::put},
    {"net.del", net::controllers::del},
    {"net.delete", net::controllers::del},
    {"net.patch", net::controllers::patch},
    {"net.head", net::controllers::head},
    {"net.options", net::controllers::options},
    // Neutralino.custom
