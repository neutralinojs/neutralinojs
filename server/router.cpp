...
namespace routes {
    pair<string, string> executeNativeMethod(string path, string postData, string token) {
        ...
        map <string, NativeMethod> methodMap = {
            ...
            {"window.__navigate", window::WindowMethods::__navigate},
            {"window.maximize", window::WindowMethods::maximize},
            {"window.unmaximize", window::WindowMethods::unmaximize},
            {"window.iconify", window::WindowMethods::iconify},
            {"window.deiconify", window::WindowMethods::deiconify},
            {"window.destroy", window::WindowMethods::destroy},
